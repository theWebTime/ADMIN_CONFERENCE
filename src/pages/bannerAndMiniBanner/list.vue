    ...
    <VCard>
      <VCardText class="d-flex flex-wrap py-4 gap-4">
        ...
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          ...
          <router-link to="/bannerAndMiniBanner/add">
            <VBtn prepend-icon="tabler-plus"> Add Banner & Mini Banner </VBtn>
          </router-link>
        </div>
      </VCardText>
      <VDivider />
        ...
        <v-data-table class="text-no-wrap" fixed-header>
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-center">Is Banner</th>
          ...
          <tbody>
            <tr v-for="(item, index) in data.data" :key="index">
              ...
              <td class="text-center">
                {{ item.is_banner == 1 ? "Banner" : "Mini Banner" }}
              </td>
              <td class="text-center">
                {{ item.title }}
              </td>
              ...
              <td class="text-center">
                <router-link
                  :to="
                    '/bannerAndMiniBanner/editBannerAndMiniBanner/' + item.id
                  "
                >
                  <IconBtn>
...
export default {
  ...
  methods: {
    ...
    deleteData() {
      http
        .post("/banner-mini-banner/delete/" + this.editableId, {})
        .then((res) => {
          if (res.data.success) {
            this.fetchData();

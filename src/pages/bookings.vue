        ...
        <v-data-table class="text-no-wrap" fixed-header>
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-center">Plan Title</th>
              <th class="text-uppercase text-center">Total Days</th>
              <th class="text-uppercase text-center">From Date</th>

        ...
        <v-data-table class="text-no-wrap" fixed-header>
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-center">Alternative Email</th>
              <th class="text-uppercase text-center">Phone Number</th>
              <th class="text-uppercase text-center">Whatsapp Number</th>
              <th class="text-uppercase text-center">Institution</th>

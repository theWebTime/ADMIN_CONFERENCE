      ...
      <VCardText class="d-flex flex-wrap py-4 gap-4">
        ...
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          ...
          <router-link to="/blog/add">
            <VBtn prepend-icon="tabler-plus"> Add Blog </VBtn>
          </router-link>
        </div>
      </VCardText>
      <VDivider />
        ...
        <v-data-table class="text-no-wrap" fixed-header>
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-center">By</th>
          ...
          <tbody>
            <tr v-for="(item, index) in data.data" :key="index">
              ...
              <td class="text-center">
                <router-link :to="'/blog/editBlog/' + item.id">
                  <IconBtn>
...
export default {
  ...
  methods: {
    ...
    deleteData() {
      http
        .post("/blog/delete/" + this.editableId, {})
        .then((res) => {
          if (res.data.success) {
            this.fetchData();

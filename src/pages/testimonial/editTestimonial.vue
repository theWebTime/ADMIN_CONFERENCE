<template>
  <div>
    ...
    <VCard title="Update Data of this Testimonial">
      <VAlert
...
export default {
  ...
  methods: {
    async fetchData() {
      this.loader = true;
      await http
        .get("/testimonial/show/" + this.paramsId)
        .then((res) => {
          if (res.data.success) {
            ...
            this.insertData.rating = resData.rating;
            this.insertData.review = resData.review;
    ...
    async updateData() {
      ...
      if (checkValidation.valid) {
        ...
        this.loader = true;
        http
          .post("testimonial/update/" + this.paramsId, formData)
          .then((res) => {
            if (res.data.success) {
              this.fetchData();
